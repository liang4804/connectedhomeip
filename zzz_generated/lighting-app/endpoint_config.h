...
\
  ...
  { (uint16_t)0x1, (uint16_t)0x0, (uint16_t)0x5 }, /* FanModeSequence */ \
...
\
  /* Endpoint: 1, Cluster: Fan Control (server) */ \
  { ZAP_MIN_MAX_DEFAULTS_INDEX(1), 0x00000000, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* FanMode */  \
  { ZAP_MIN_MAX_DEFAULTS_INDEX(2), 0x00000001, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* FanModeSequence */  \
  { ZAP_MIN_MAX_DEFAULTS_INDEX(3), 0x00000002, 1, ZAP_TYPE(PERCENT), ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* PercentSetting */  \
  ...
  { ZAP_MIN_MAX_DEFAULTS_INDEX(4), 0x00000005, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* SpeedSetting */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 22, 252 }, \
  { ZAP_CLUSTER_INDEX(22), 4, 33 }, \
}
...
#define FIXED_DEVICE_TYPES {{0x0016,1},{0x002B,1}}
